...
class BreadthFirstSearch(unittest.TestCase):
    ...
    def test_simple_graph(self):
        ...
        depth_first = breadth_first_search(node_1)
        self.assertEqual(depth_first.get(0), [node_1])
        self.assertEqual(depth_first.get(1), [node_2])
        self.assertEqual(depth_first.get(2), [node_3])
    ...
    def test_large_graph_with_cycle(self):
        ...
        depth_first = breadth_first_search(node_2)
        self.assertEqual(depth_first.get(0), [node_2])
        self.assertEqual(depth_first.get(1), [node_0, node_3])
        self.assertEqual(depth_first.get(2), [node_1])
